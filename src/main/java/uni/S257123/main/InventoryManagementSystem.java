...
//	static String itemsFilePath = "src/main/resources/items.txt";
//	static String transactionsFilePath = "src/main/resources/transactions.txt";
//	static List<CSV> items = TextStorage.ReadContents(itemsFilePath);
//	static List<CSV> transactions = TextStorage.ReadContents(transactionsFilePath);
//
//	/**
...
public class InventoryManagementSystem
{
	...
	private static void MenuOptions(int option) {
		switch (option) {
			case 1 -> {
			...
			case 3 -> ui.UpdateRecordInput();
			case 4 -> ui.RemoveRecordInput();
			case 5 -> ui.DisplaySearch(storage.SearchRecord("transactions", Pair.of("date",ui.ViewTransactionsInput())));
			case 6 -> ui.DisplaySearch(storage.SearchRecord("items",Pair.of("id","")));
			case 7 -> sessionActive = false;
			default -> System.out.println("Unexpected error occurred, please enter an integer!");
		}
	}
